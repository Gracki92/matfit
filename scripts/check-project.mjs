...
const [html, app, planner, styles, serviceWorker, manifestText] = await Promise.all([
...
for (const asset of ["./index.html", "./assets/styles.css", "./src/app.js", "./src/domain/planner.js"]) {
